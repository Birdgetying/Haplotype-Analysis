...
Next action: for the wheat teacher targets, either obtain a chr6B genotype source covering the TaGW2-B1 promoter diagnostic SNPs, or treat VRN-Kiss2014 as a secondary/weak positive control and move to another star gene with a larger segregating functional haplotype.
